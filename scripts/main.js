...
// console.log("Marketing is a nice department to work in. " + departments.marketing.description);
// console.log("The customer service department has " + departments.customerService.numberOfEmployees + " employees.");
// console.log("1d: Sales is a challenging department to work in as a Sales Manager. " + departments.sales.jobs[2].description);

// opdracht 2
// const userInput = prompt("Hi! What's your name?");
// console.log(userInput);

// opdracht 2a
// const userInput2a = prompt("Over welke afdeling wil je meer informatie? Kies uit: marketing / sales / customer /" +
//     "  service]") ;
//     " customer-service]");
// console.log(userInput2a);

// opdracht 2b
// let userInput2b = prompt("Over welke afdeling wil je meer informatie? Kies uit: [marketing / sales /" +
//     " customer-service]");

// let x;
// if (userInput2b == 'marketing') {
//     x = departments.marketing.description
//     console.log("2B: Je koos " + userInput2b + ". " + x);
//     }
// if (userInput2b == 'sales') {
//     x = departments.sales.description
//     console.log("2B: Je koos " + userInput2b + ". " + x);
// }
// if (userInput2b == 'customer service') {
//     x = departments.customerService.description
//     console.log("2B: Je koos " + userInput2b + ". " + x);
// }
// else {
//     console.error("2C: Ongeldige keuze. Probeer het opnieuw door de pagina te verversen.");
// }


// 3b

// let userInput3a = prompt("Je koos marketing. Over welke functie wil je meer weten? Voer een getal tussen 0 en 3" +
...
// Opdracht 5
const changeTitle = document.getElementById('role-title')
const departmentDescription = document.getElementById('department-description')
const roleDescription = document.getElementById('role-description')

const userInput_copy_van_2a = prompt("Over welke afdeling wil je meer informatie? Kies uit: marketing / sales /" +
    " customer " +
    "service]") ;

switch (userInput_copy_van_2a) {
    case 'marketing':
        changeTitle.textContent = 'Marketing';
        departmentDescription.textContent = departments.marketing.description;
        let userInputSMarketing = prompt("Je koos marketing. Over welke functie wil je meer weten? Voer een getal tussen" +
            " 0 en 4" +
            " in: \n 0: Marketingmanager, \n 1: Digital Marketing Specialist, \n 2: Contentmarketeer, \n 3: Branding" +
            " Agent \n 4: Marktonderzoeksanalist");
        roleDescription.textContent = departments.marketing.jobs[userInputSMarketing].description;
        break;
    case 'sales':
        changeTitle.textContent = 'Sales';
        departmentDescription.textContent = departments.sales.description;
        let userInputSales = prompt("Je koos Sales. Over welke functie wil je meer weten? Voer een getal tussen" +
            " 0 en 3" +
            " in: \n 0: Sales Representative, \n 1: Verkoopmanager, \n 2: Accountmanager, \n 3: Business Development Manager");
        roleDescription.textContent = departments.sales.jobs[userInputSales].description;
        break;
    case 'customer service':
        changeTitle.textContent = 'Customer Service';
        departmentDescription.textContent = departments.customerService.description;
        let userInputCustomerService = prompt("Je koos customer service. Over welke functie wil je meer weten? Voer" +
            " een" +
            " getal tussen" +
            " 0 en 3" +
            " in: \n 0: Klantenservicemedewerker, \n 1: Klantenondersteuningsspecialist, \n 2: Client Success Manager, \n 3: Customer Experience Manager");
        roleDescription.textContent = departments.customerService.jobs[userInputCustomerService].description;
        break;
    default:
        changeTitle.textContent = 'Ongeldige keuze. Probeer het opnieuw door de pagina te verversen.';
}
